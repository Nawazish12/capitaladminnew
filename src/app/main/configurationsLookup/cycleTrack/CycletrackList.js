...
import CycletrackDialog from "./CycletrackDialog";

const CycletrackList = () => {
  ...
  const { data: cycleTrackData = [], isLoading } = useQuery(
    ["getcycleTrackData", pageIndex, pageSize],
    () =>
      axios.get("/cycle_track", {
        params: {
          page_size: pageSize,
